    ...
    while(matches = mentionRegex.exec(body)) {
        ...
        if(!matches[3]) {
            ...
            if(!alreadyEncountered.includes(mention)) {
                ...
                const socialNetworksRegex = /(insta|tele)gram|tw(it?ter|eet)|facebook|golos|weku|whaleshares?|discord|smoke\.?io|medium|minds|brunch|unsplash|텔레그램|推特|[^a-z.](ig|rt|fb|ws|eos)[^a-z.]|t.(me|co)\//i;
